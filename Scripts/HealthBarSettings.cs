...
namespace HealthBarMod
{
    public class HealthBarSettings
    {
        ...
        public void MessageBox()
        {
            ...
            "Press the Spacebar to reset the position of the bar.", "Your options will automatically be saved; press the Backslash key again to exit this menu.", "When finished, uncheck 'Advanced Location Positioning and Scaling' from the Mod Settings page."};
        ...
        public void OnClose()
        {
            ...
            EnemyHealthBarMain.Instance.activated++;
        }
